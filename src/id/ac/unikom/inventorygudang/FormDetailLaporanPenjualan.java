 ...
 */
public class FormDetailLaporanPenjualan extends javax.swing.JDialog {
    ...
    public FormDetailLaporanPenjualan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void btnCetakLaporanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakLaporanActionPerformed
        ...
        if (tglAwal != null && tglAkhir != null) {
            if (tglAkhir.getTime() > tglAwal.getTime()) {
                ...
                dispose();
                try {
                    File report = new File("src\\id\\ac\\unikom\\inventorygudang\\report\\ReportPenjualan.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDetailLaporanPenjualan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormDetailLaporanPenjualan dialog = new FormDetailLaporanPenjualan(new javax.swing.JFrame(), true);
